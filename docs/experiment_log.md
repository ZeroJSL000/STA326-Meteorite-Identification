...
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260531-133906-convnextv2_base_384_final_hard_answer

- 时间: 2026-05-31T13:39:06+08:00
- 实验名: `convnextv2_base_384_final_hard_answer`
- Config: `/Work/project/STA326new/configs/convnextv2_base_384_final_hard_answer.yaml`
- Backbone: `convnextv2_base.fcmae_ft_in22k_in1k`
- Pooling: `GAP (timm default)`
- 图像尺寸: `384 x 384`
- Loss: `BCEWithLogitsLoss()`
...
| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 681 | 496 | 0.728341 | plain_bce | 0.958580 |
| 1 | 681 | 496 | 0.728341 | plain_bce | 0.943820 |
| 2 | 682 | 496 | 0.727273 | plain_bce | 0.964497 |
| 3 | 682 | 496 | 0.727273 | plain_bce | 0.954023 |
| 4 | 682 | 496 | 0.727273 | plain_bce | 0.962963 |

- OOF F1: `0.945899`
- OOF 最优阈值: `0.520000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/convnextv2_base_384_final_hard_answer/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260531-151412-swin_base_384_final_hard_answer

- 时间: 2026-05-31T15:14:12+08:00
- 实验名: `swin_base_384_final_hard_answer`
- Config: `/Work/project/STA326new/configs/swin_base_384_final_hard_answer.yaml`
- Backbone: `swin_base_patch4_window12_384.ms_in22k_ft_in1k`
- Pooling: `GAP (timm default)`
- 图像尺寸: `384 x 384`
- Loss: `BCEWithLogitsLoss()`
...
| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 681 | 496 | 0.728341 | plain_bce | 0.965909 |
| 1 | 681 | 496 | 0.728341 | plain_bce | 0.948864 |
| 2 | 682 | 496 | 0.727273 | plain_bce | 0.967742 |
| 3 | 682 | 496 | 0.727273 | plain_bce | 0.951009 |
| 4 | 682 | 496 | 0.727273 | plain_bce | 0.950437 |

- OOF F1: `0.952601`
- OOF 最优阈值: `0.490000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/swin_base_384_final_hard_answer/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260531-165420-swin_base_384_friend_cleaned_raw

- 时间: 2026-05-31T16:54:20+08:00
- 实验名: `swin_base_384_friend_cleaned_raw`
- Config: `/Work/project/STA326new/configs/swin_base_384_friend_cleaned_raw.yaml`
- Backbone: `swin_base_patch4_window12_384.ms_in22k_ft_in1k`
- Pooling: `GAP (timm default)`
- 图像尺寸: `384 x 384`
- Loss: `BCEWithLogitsLoss()`
...
| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 2129 | 1807 | 0.848755 | plain_bce | 0.987884 |
| 1 | 2129 | 1808 | 0.849225 | plain_bce | 0.985915 |
| 2 | 2130 | 1807 | 0.848357 | plain_bce | 0.986867 |
| 3 | 2130 | 1807 | 0.848357 | plain_bce | 0.978444 |
| 4 | 2130 | 1807 | 0.848357 | plain_bce | 0.982193 |

- OOF F1: `0.982917`
- OOF 最优阈值: `0.560000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/swin_base_384_friend_cleaned_raw/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260531-185100-convnextv2_base_384_friend_cleaned_raw

- 时间: 2026-05-31T18:51:00+08:00
- 实验名: `convnextv2_base_384_friend_cleaned_raw`
- Config: `/Work/project/STA326new/configs/convnextv2_base_384_friend_cleaned_raw.yaml`
- Backbone: `convnextv2_base.fcmae_ft_in22k_in1k`
- Pooling: `GAP (timm default)`
- 图像尺寸: `384 x 384`
- Loss: `BCEWithLogitsLoss()`
...
| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 2129 | 1807 | 0.848755 | plain_bce | 0.988806 |
| 1 | 2129 | 1808 | 0.849225 | plain_bce | 0.985019 |
| 2 | 2130 | 1807 | 0.848357 | plain_bce | 0.984127 |
| 3 | 2130 | 1807 | 0.848357 | plain_bce | 0.977444 |
| 4 | 2130 | 1807 | 0.848357 | plain_bce | 0.983146 |

- OOF F1: `0.981723`
- OOF 最优阈值: `0.400000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/convnextv2_base_384_friend_cleaned_raw/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260602-023718-swinv2_base_384_minimal_external_081818

- 时间: 2026-06-02T02:37:18+08:00
- 实验名: `swinv2_base_384_minimal_external_081818`
- Config: `/Work/project/STA326new/configs/swinv2_base_384_minimal_external_081818.yaml`
...
- LLRD: `head_lr=5.00e-04`, `backbone_lr=5.00e-05`
- Scheduler: `CosineAnnealingLR`
- 数据增强: minimal: LongestMaxSize + zero PadIfNeeded + Normalize + ToTensor only; no color/geometric/degradation/dropout augmentation

| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 681 | 496 | 0.728341 | plain_bce | 0.961194 |
| 1 | 681 | 496 | 0.728341 | plain_bce | 0.951289 |
| 2 | 682 | 496 | 0.727273 | plain_bce | 0.955224 |
| 3 | 682 | 496 | 0.727273 | plain_bce | 0.964706 |
| 4 | 682 | 496 | 0.727273 | plain_bce | 0.960000 |

- OOF F1: `0.954545`
- OOF 最优阈值: `0.460000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/swinv2_base_384_minimal_external_081818/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
## EXP-20260602-113451-swinv2_base_384_minimal_pseudo0818

- 时间: 2026-06-02T11:34:51+08:00
- 实验名: `swinv2_base_384_minimal_pseudo0818`
- Config: `/Work/project/STA326new/configs/swinv2_base_384_minimal_pseudo0818.yaml`
- Backbone: `swinv2_base_window12to24_192to384.ms_in22k_ft_in1k`
- Pooling: `GAP (timm default)`
- 图像尺寸: `384 x 384`
- Loss: `BCEWithLogitsLoss()`
...
| Fold | Train Positive | Train Negative | Class Ratio | Loss Weight | Best Valid F1 |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 771 | 600 | 0.778210 | plain_bce | 0.949853 |
| 1 | 771 | 600 | 0.778210 | plain_bce | 0.944928 |
| 2 | 772 | 600 | 0.777202 | plain_bce | 0.941860 |
| 3 | 772 | 600 | 0.777202 | plain_bce | 0.952941 |
| 4 | 772 | 600 | 0.777202 | plain_bce | 0.925816 |

- OOF F1: `0.938084`
- OOF 最优阈值: `0.440000`
- 阈值搜索: `0.10..0.90, step=0.01, maximize F1`
- 阈值文件: `/Work/project/STA326new/outputs/swinv2_base_384_minimal_pseudo0818/optimal_threshold.json`
- Kaggle LB Score: `待补充`
- 后续推断改进方向: 待补充
